...
lib/src/
  ...
  tui/
    ...
    design/                    shared TUI design system (mirrors wsrun_cli's component/theme
                               conventions) — every screen composes these, no raw nocterm
      ...
      loading_text.dart, body_text.dart, divider.dart, progress_bar.dart,
      copyable_scroll_body.dart  the rest of the shared components
      design.dart                barrel — screens import this instead of nocterm directly
...
.cache/                       generated by sync / normal use, git-ignored — one <folderName>.json
                               ...
                               last_full_sync.json (`{"at": "<iso8601>"}`)
```
